...
function preloader(){try{document.body.onload=function(){setTimeout(()=>{AOS.init()},500)}}catch{console.error()}}
preloader();let burger_btn=document.querySelector(".header__burger-btn");let burger_btn_close=document.querySelector(".header__burger-btn_close");let mobileMenu=document.querySelector(".mobile-menu");let burger_menu=document.querySelector(".header__modal");let menuBody=document.querySelector("body");burger_btn.addEventListener("click",toggleMenu);burger_btn_close.addEventListener("click",toggleMenu);function toggleMenu(){burger_menu.classList.toggle("active");burger_btn.classList.toggle("active");mobileMenu.classList.toggle("active");menuBody.classList.toggle("_active1")}
var $item=$('.footer_menu_mob_wrap .menu-item-has-children a');$item.first().on("click",function(e){e.preventDefault();var $this=$(this);$(".sub-menu").toggleClass("sub-menu_active");$(".menu-item-has-children a").toggleClass("menu-item-has-children_active");console.log('aaa')});$(".postItem-cpt_wrap .btn_circle, .postItem-cpt_wrap .item-name, .postItem-cpt_wrap .leistungen-img").on("click",function(e){e.preventDefault();var $this=$(this);var i=0;if($this.parents(".postItem-cpt").hasClass("post_active")){i=1}
$(".postItem-cpt").removeClass("post_active");$(".postItem-cpt_wrap .btn_circle").removeClass("btn_circle_active");if(i==1){$this.parents(".postItem-cpt").addClass("post_active");$(".post_active .btn_circle").addClass("btn_circle_active")}
if($this.parents(".postItem-cpt").hasClass("post_active")){$(".post_active .btn_circle").removeClass("btn_circle_active");$this.parents(".postItem-cpt").removeClass("post_active")}else{$this.parents(".postItem-cpt").addClass("post_active");$(".post_active .btn_circle").addClass("btn_circle_active")}
$(".wrapper-show").removeClass("wrapper-show_active");$(".post_active .wrapper-show").toggleClass("wrapper-show_active")});$(".postItem-references_wrap .btn_circle, .postItem-references_wrap .item-name, .postItem-references_wrap .leistungen-img").on("click",function(e){e.preventDefault();var $this=$(this);var i=0;if($this.parents(".postItem-references").hasClass("post_active")){i=1}
$(".postItem-references").removeClass("post_active");$(".postItem-references_wrap .btn_circle").removeClass("btn_circle_active");if(i==1){$this.parents(".postItem-references").addClass("post_active");$(".post_active .btn_circle").addClass("btn_circle_active")}
if($this.parents(".postItem-references").hasClass("post_active")){$(".post_active .btn_circle").removeClass("btn_circle_active");$this.parents(".postItem-references").removeClass("post_active")}else{$this.parents(".postItem-references").addClass("post_active");$(".post_active .btn_circle").addClass("btn_circle_active")}
$(".wrapper-show").removeClass("wrapper-show_active");$(".post_active .wrapper-show").toggleClass("wrapper-show_active")});
