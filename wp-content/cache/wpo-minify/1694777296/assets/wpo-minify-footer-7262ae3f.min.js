...
var $item=$('.footer_menu_mob_wrap .menu-item-has-children a');$item.first().on("click",function(e){e.preventDefault();var $this=$(this);$(".sub-menu").toggleClass("sub-menu_active");$(".menu-item-has-children a").toggleClass("menu-item-has-children_active");console.log('aaa')});$(".postItem-cpt_wrap .btn_circle").on("click",function(e){e.preventDefault();var $this=$(this);var i=0;if($this.parents(".postItem-cpt").hasClass("post_active")){i=1}
$(".postItem-cpt").removeClass("post_active");$this.toggleClass("btn_circle_active");if(i==1){$this.parents(".postItem-cpt").addClass("post_active")}
if($this.parents(".postItem-cpt").hasClass("post_active")){$this.parents(".postItem-cpt").removeClass("post_active")}else{$this.parents(".postItem-cpt").addClass("post_active")}
$(".wrapper-show").removeClass("wrapper-show_active");$(".post_active .wrapper-show").toggleClass("wrapper-show_active")});$(".postItem-references_wrap .btn_circle").on("click",function(e){e.preventDefault();var $this=$(this);var i=0;if($this.parents(".postItem-references").hasClass("post_active")){i=1}
$(".postItem-references").removeClass("post_active");$this.toggleClass("btn_circle_active");if(i==1){$this.parents(".postItem-references").addClass("post_active")}
if($this.parents(".postItem-references").hasClass("post_active")){$this.parents(".postItem-references").removeClass("post_active")}else{$this.parents(".postItem-references").addClass("post_active")}
